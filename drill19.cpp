...
//template - forditas ideju
//auto - futasi ideju

using namespace std;

template<typename T>
struct S { //generikus osztály
...
template<typename T>
void read_val(T& v){
	cin >> v; //vektorra nem ertelmezett
}
...
int main(){
	...
	S<std::vector<int>> svi {std::vector<int>{1,1,2,3,5,8}}; //s tipusu objektum, vektort tartalmaz, ami int-eket tartalmaz
